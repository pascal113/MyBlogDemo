...
export function* login(username, password) {
    ...
    try {
        ...
        yield put({type:IndexActionTypes.SET_MESSAGE,msgContent:'Username or password are wrong',msgType:0});
    } finally {
...
export function* register (data) {
    ...
    try {
        ...
        yield put({type:IndexActionTypes.SET_MESSAGE,msgContent:'Register fail',msgType:0});
    } finally {
        yield put({type: IndexActionTypes.FETCH_END});
    }
}
